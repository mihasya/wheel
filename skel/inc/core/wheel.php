...
abstract class wheel {
   ...
   */
  public static function dispatch($controller, $action, $partial = false) {
    ...
    if (is_array($result)) {
      switch ($result['directive']) {
        case 'forward': {
          return wheel::dispatch($result['controller'], $result['action'], $partial);
          break;
        }
        default: {
          break;
    ...
    if ($partial || $control->_layout==null)
